...
class CreateEmdefinitionstableTempTable extends Migration {
	...
	public function up()
	{
		Schema::create('emdefinitionstable_temp', function(Blueprint $table)
		{
	...
	{
		Schema::drop('emdefinitionstable_temp');
	}
