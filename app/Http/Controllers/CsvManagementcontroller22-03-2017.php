        ...
        foreach ($definitions_data as $pages)
        {
            ...
            if (!empty($definitions_data_mapping))
            {
                foreach ($definitions_data_mapping as $maped_data)
                {
                    ...
                    $mapped_mappedItemId        = $maped_data->mappedItemId;
                    $mapped_code_unique_id      = $maped_data->nationaldataId;
                }
                ...
                $checkmaparr[$checkmapindex]["code_unique_id"]  = $mapped_code_unique_id;
                $checkmapindex++;
                ...
                $mapped_nationaldataId_ref_val                  = $mapped_nationaldataId;
                $mappunid++;
            }
            ...
            else
            {
                if ($uniquecodeId == 1)
                {
                    ...
                    $unique_id_print                                            = "RDI.".$dataitemid_padded . "." . $zero_x_padded . "." . $zero_x_padded . "." . $zero_x_padded . "." . $zero_x_padded . "." . $zero_x_padded;
            ...
            $groupuniid_padded                          = sprintf("%05d", $pages->group_uniq_id);
            $mappunid_padded                            = sprintf("%05d", $mapped_mappedItemId);
            ...
            if($mapped_nationaldataId_ref_val!=0){
                $mapped_nationaldataId_padded_print     = "UKHF.".$mapped_nationaldataId_padded;
            }
            else{
                $mapped_nationaldataId_padded_print     =  $mapped_nationaldataId_padded;
            }
            ...
            $unique_id_print = "RDI.".$dataitemid_padded . "." . $uniquecodeId_padded . ".V1." . $pages->dataItemVersionId."." . $mappunid_padded_ins . "." . $mapped_nationaldataId_padded_print . "." . $mappcodedid_padded_ins . "." . $groupuniid_padded_ins;
