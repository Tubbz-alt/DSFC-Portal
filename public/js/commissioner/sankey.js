var renameKeys = [
        {orig: "activity_type", new: "Activity Type"},
        {orig: "challenge_category", new: "Challenge Category"},
        {orig: "investigated", new: "Investigated"},
        {orig: "outcome_category", new: "Outcome Category"},
        {orig: "expected_result", new: "Expected Result"},
        {orig: "CDSDATE", new: "Date"}
    ],
...
var jsonUrl = 'commissioner/commissioner-challenges-flow-data?asd="123213"';
//capture data
