...
@section('content')
	<div id="content-wrapper" class="container">
		...
		<div class="form-group row">
			<div class="col-xs-12 col-md-2">
				{!! Form::label('nhs_organisation', 'NHS Organisations') !!}
			</div>
			<div class="col-xs-12 col-md-10">
				{!! Form::select('nhs_organisation',  (
                [
                'nhs_organisation' => 'NHS Organisations'
                ]),  $user_details, ['class' => 'form-control validate[required] selectbox_submit']) !!}
			</div>
		</div>
			<div class="form-group row">
