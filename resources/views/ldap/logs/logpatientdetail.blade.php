    ...
    <div id="content-wrapper" class="container">
        <section class="col-sm-12">
            <!-- <div class="section-header">
                <h1>Patient Detail</h1><br>
            </div> -->
          {{--  <div class="col-sm-9 header_title">
                <h3 style="margin-top:11px; ">Patient Detail</h3><br>
            </div>--}}
        ...
        <div class="panel panel-default row">
            <div class="col-xs-12 col-md-12">
                ...
                <div class=" col-md-3 pull-right  ">
                    ...
                    {!! Form::open(array('url' => 'admin/logs/search-logs-patient', 'method'=>'get','id'=>'','class'=>'formclass')) !!}

                    {!! Form::text('search', (Session::has('SearchLogsPatient'))? Session::get('SearchLogsPatient') :null, 
                     array('required', 
                            'placeholder'=>'Search','class'=>'inputheight')) !!}
                    {!! csrf_field() !!}
                    @if(Session::has('SearchLogsPatient'))

                        <a href="{{url('admin/logs/logs-patient-detail')}}"
                    ...
                    <a href="{{url('admin/logs/export-patientdetail')}}" class='exportcsv'></a>
                </div>
                    </div>
            </div>
                ...
                @if(count($logpatientdetail)>0)
                    ...
                    @foreach($logpatientdetail as $value)
                        <tr>
                            ...
                            <td>{{ $value->bed }}</td>
                            <td>{{ $value->actual_ward }}</td>
                            <td>{{ $value->admit_dt }}</td>
