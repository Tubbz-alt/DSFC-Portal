...
@section('content')
	<div id="content-wrapper" class="container">
		<section class="col-sm-12">
			...
			{!! Form::open(array('url' => 'admin/rtt/non-admitted-search','method'=>'get','class' => 'form-inline inline', 'style' => 'display: inline')) !!}
	    	...
	    	{!! Form::close() !!}
				<a href="{{url('media/rtt/rtt_non_admitted.ods')}}" class="btn btn-primary btn-sm" download target="_blank">Download Sample</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			{!! Form::open(array('url' => 'admin/rtt/non-admitted', 'method'=>'post', 'enctype' => 'multipart/form-data')) !!}
