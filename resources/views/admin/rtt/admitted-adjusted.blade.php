	...
	<div id="content-wrapper" class="container">
		<section class="col-sm-12">
			...
			<div class="col-xs-12 col-md-6 text-right">
				{!! Form::open(array('url' => 'admin/rtt/admitted-search','method'=>'get','class' => 'form-inline inline', 'style' => 'display: inline')) !!}
	    		...
	    		{!! Form::close() !!}
				<a href="{{url('media/rtt/rtt_admitted_adjusted.ods')}}" class="btn btn-primary btn-sm" download target="_blank">Download Sample</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			{!! Form::open(array('url' => 'admin/rtt/admitted-adjusted', 'method'=>'post', 'enctype' => 'multipart/form-data')) !!}
