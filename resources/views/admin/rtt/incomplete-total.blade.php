	...
	<div id="content-wrapper" class="container">
		<section class="col-sm-12">
			...
			<div class="col-xs-12 col-md-6 text-right">
				{!! Form::open(array('url' => 'admin/rtt/in-complete-total-search','method'=>'get','class' => 'form-inline inline', 'style' => 'display: inline')) !!}
					...
					@if (count($aat_list) > 0)
						...
						@foreach ($aat_list as $aat)
							<tr>
								...
								<td>{{$aat->bw_51_52}}</td>
								<td>{{$aat->plus_52}}</td>
								<td>{{$aat->total_number_of_incomplete_pathways}}</td>
								<td>{{$aat->total_within_18_weeks}}</td>
