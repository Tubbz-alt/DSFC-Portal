	...
	<div  class="container">
		...
		<div class="tabBlock">
			...
			<div class="tabBlock-content" >
						...
						<table class="filtertable_definitions table  table-striped table-bordered definitions-table horizontal_scroll">
							@if (count($definitions_data) > 0)
								...
								<tr>
                                    ...
                                    <th class="text-center ">Mapping Info</th>
									<th class="text-center">Status<span class="glyphicon glyphicon-triangle-right view-more" id="show"></span> </th>


									<th class="text-center invisible-data">Data Item Description </span> </th>
								...
								@foreach ($definitions_data as $pl)
									...
									<tr>
                                        ...
                                        <td class="text-center ">{{$pl->mappingComments}}</td>
                                        <td class="text-center">{{$pl->dataItem}}</td>
                                        <td class="text-center ">{{$pl->mappingInfo}}</td>
										...
										<td class="text-center invisible-data">{{$pl->dataItemDescription}}
				...
				<div class="tabBlock-pane">
                    <div class="container hiddencontainer hiddencontent">
                        <table class="table filtertable_dditems table-striped table-bordered dd-item-table">
                            @if (count($dditems) > 0)
                            <thead>
                            <tr>
                                ...
                                <tbody>
                                @foreach ($dditems as $pl)

                                <tr>
                                    <td class="text-center">{{$pl->itemName}}</td>
                                    <td class="text-center">{{$pl->itemType}}</td>
                                    <td class="text-center"><a href="{{$pl->url}}" target="_blank">URL</a></td>
