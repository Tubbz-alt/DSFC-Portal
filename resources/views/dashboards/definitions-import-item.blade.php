					...
					@if (count($csv_list) > 0)
						...
						@foreach ($csv_list as $pl)
							<tr>
								...
								<td>
									<a href="javascript:void(0)" class="patient-detail-hover details-hover">Versions</a>
								</td>
...
<div class="modal fade" id="csvDataModel" tabindex="-1" role="dialog" aria-labelledby="csvDataModelLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			{!! Form::open(array('url' => 'dashboard/data-definitions/store-dditems','files' => true, 'method'=>'post', 'enctype' => 'multipart/form-data')) !!}
